...
function New-TestList {
    ...
    $all = @(
        ...
        'test-generated-project-preview.ps1',
        'test-generated-project-appid.ps1',
        'test-generated-project-upload.ps1',
        'test-wechat-generate-page.ps1',
        'test-generation-gate-component-v1.ps1',
        'test-wechat-apply-component-bundle.ps1',
        'test-wechat-generate-component.ps1',
        'test-generation-gate-app-json-v1.ps1',
        'test-wechat-apply-app-json-patch.ps1',
        'test-wechat-patch-app-json.ps1',
